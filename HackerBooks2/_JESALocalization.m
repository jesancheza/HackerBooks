...
// Make changes to JESALocalization.m instead.

#import "_JESALocalization.h"

const struct JESALocalizationAttributes JESALocalizationAttributes = {
	.address = @"address",
	.latitude = @"latitude",
	.longitude = @"longitude",
};

const struct JESALocalizationRelationships JESALocalizationRelationships = {
	.annotation = @"annotation",
};

@implementation JESALocalizationID
@end

@implementation _JESALocalization
...
- (JESALocalizationID*)objectID {
	return (JESALocalizationID*)[super objectID];
}
